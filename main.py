...
translations = {
    "uz": {
        ...
        "months": "Necha oyga olmoqchisiz? (24, 36 yoki 48)",
        "client_type": "Iltimos, mijoz turini tanlang:",
        "amount_error": "Iltimos, to'g'ri summa kiriting.",
        "months_error": "Faqat 24, 36 yoki 48 oyni kiriting.",
    ...
    "ru": {
        ...
        "months": "На сколько месяцев вы хотите взять? (24, 36 или 48)",
        "client_type": "Пожалуйста, выберите тип клиента:",
        "amount_error": "Пожалуйста, введите корректную сумму.",
        "months_error": "Введите только 24, 36 или 48 месяцев.",
...
def calculate_and_send_result(chat_id):
    ...
    # 🔽 Добавляем процентные ставки под графиком
    if lang == "uz":
        result += (
            "\n\n📌 Foiz stavkalari:\n"
            "Davlat xizmatchisi:\n"
